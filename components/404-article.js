...
export default function FourZeroFourArticle() {
  return (
    <div className="flex flex-col items-start justify-start md:justify-center md:items-center md:flex-row md:space-x-6 md:mt-24">
      ...
      <div className="max-w-md">
        <p className="mb-4 text-xl font-bold leading-normal md:text-2xl">
          Sorry no post was found on this page.
        </p>
        <p className="mb-8">
          It seems like the author hasn't written any posts yet either because he feels like he has
          nothing unique to say or he is just being lazy. He thought that buying a domain would give
          him a little push to at least get started but alas he thought wrong.
        </p>
        <Link href="/about">
